...
/* Definitions for _WiFiTask */
osThreadId_t _WiFiTaskHandle;
const osThreadAttr_t _WiFiTask_attributes = {
  .name = "_WiFiTask",
  .stack_size = 2048 * 4,
    ...
    ***************************************************************************/
    size_t __write(int handle, const unsigned char * buffer, size_t size)
    {
        ...
        if (buffer != NULL)
        {
            ...
            {
                HAL_UART_Transmit(&huart3, (uint8_t *)buffer, 1, 0xFFFF);
                ++buffer;
            }
        }
        return (nChars);
...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  /* Create the thread(s) */
  /* creation of _WiFiTask */
  _WiFiTaskHandle = osThreadNew(WiFiTask, NULL, &_WiFiTask_attributes);
...
/**
  * @brief  Function implementing the _WiFiTask thread.
