...
/* Wi-Fi Connection related parameters */
   ...
   #define WIFI_SSID                       "TP-LINK_A76D_5G"
#endif /* (WIFI_SSID) */
#if  !defined(WIFI_PASSWORD)
   #define WIFI_PASSWORD                   "36191321"
#endif /* (WIFI_PASSWORD) */
...
extern osThreadId_t       _WiFiTaskHandle;
                          ...
                          cy_wcm_scan_status_t status)
{
    ...
    if (scan_data != NULL)
    {
        ...
        {
            xTaskNotify(_WiFiTaskHandle, 0, eNoAction);
        }
        else
        {
       ...
       // MQTT_FLAG = 1;
        ...
        while (1)
        {
        	...
        	if(count % 60 == 0)
        	{
        		count =0;
        		printf("\r\nSending data ... \r\n");
        		generate_package_data(json_string);
